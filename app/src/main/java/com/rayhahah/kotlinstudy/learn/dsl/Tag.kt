package com.rayhahah.kotlinstudy.learn.dsl

import com.rayhahah.kotlinstudygradle.dsl.StringNode
...
open class Tag(val name: String) : Node {
    ...
    var proerties = HashMap<String, String>()
    ...
    operator fun Tag.plus(node: Node) {
        children.add(node)
    }
    ...
    override fun render(): String {
        ...
        return StringBuilder()
                ...
                .append(">")
                //遍历子节点，将Node转换成String然后拼接到当前StringBuilder当中
                .let { stringBuilder ->
